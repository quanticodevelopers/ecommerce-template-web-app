    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
        <div className="relative space-y-0.5 text-red-600 dark:text-red-100">
          ...
          <p className="text-sm">Por favor procede con cuidado, esta acción no se puede deshacer.</p>
        </div>
        ...
        <Dialog>
          ...
          <DialogContent>
            ...
            <DialogDescription>
              Una vez que tu cuenta sea eliminada, todos sus recursos y datos también serán eliminados permanentemente. Por favor ingresa tu contraseña para confirmar que deseas
