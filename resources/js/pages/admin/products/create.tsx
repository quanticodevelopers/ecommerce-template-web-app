import { PackageAddIcon, SaveIcon } from '@hugeicons/core-free-icons'
import { Head, Link, useForm } from '@inertiajs/react'
import type { SubmitEvent } from 'react'
import { store as productsStore } from '@/actions/App/Http/Controllers/Admin/ProductController'
...
export default function ProductsCreate({ brands, categories }: ProductsCreateProps) {
      ...
      >
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <Heading
            ...
            description="Completa la información para agregar un producto al catálogo."
            badgeIcon={PackageAddIcon}
            badgeLabel="Catálogo"
          />
          <Button
            asChild
