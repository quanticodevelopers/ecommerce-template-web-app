    ...
    <Card className="shadow-none">
      ...
      <CardContent className="gap-6">
        <section className="space-y-2">
          ...
          <p className="leading-6 text-muted-foreground">{product.short_description ?? 'No se registró una descripción corta.'}</p>
        </section>
        ...
        <section className="space-y-3 border-t pt-6">
          ...
          {product.description ? (
            <div
              className="max-w-none leading-7 text-muted-foreground [&_a]:text-primary [&_a]:underline [&_blockquote]:border-l-2 [&_blockquote]:pl-4 [&_h2]:mt-6 [&_h2]:mb-3 [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-foreground [&_h3]:mt-5 [&_h3]:mb-2 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:text-foreground [&_h4]:mt-4 [&_h4]:mb-2 [&_h4]:font-semibold [&_h4]:text-foreground [&_ol]:list-decimal [&_ol]:pl-6 [&_p+p]:mt-3 [&_strong]:font-semibold [&_strong]:text-foreground [&_ul]:list-disc [&_ul]:pl-6"
